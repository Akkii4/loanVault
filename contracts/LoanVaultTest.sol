...
contract LoanVaultTest is Ownable {
    ...
    constructor(address _oracle, string memory name, string memory symbol) {
        stablecoin = new MockToken(name, symbol);
     ...
     */
    function getEthUsdExchangeRate() public pure returns (uint) {
